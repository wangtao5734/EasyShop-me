...
import com.feicui.wt.easyshop_20170206.main.me.MeFragment;
import com.feicui.wt.easyshop_20170206.main.shop.ShopFragment;
...
//初始化视图
    private void init() {
        ...
        //viewpager设置滑动监听，用于控textview的展示
    ...
    public void onBackPressed() {
        if (isExit) {
            isExit = true;
            activityUtils.showToast("点击两次退出程序");
            //两秒内再次点击返回则退出
